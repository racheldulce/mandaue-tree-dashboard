...
**Key Findings:**
- Top species-rich barangays: **Jagobiao** (45 species), **Subangdaku** (45 species), **Labogon** (44 species).
...
**Methodology:**
- Filtered dataset to Native trees (7,434 records with valid coordinates).
...
**Key Findings:**
- **Top Priority Barangays:** Subangdaku (Score: 10.0), Umapad (6.92), Guizo (5.85), Jagobiao (5.83).
